...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="Index_rec.php">
        <i class="bi bi-envelope"></i>
          <span>Affichage Reclamation</span>
        </a>
  ...
  <main id="main" class="main">
    ...
    <div class="card-body pb-0">
                  ...
                  <table class="table table-borderless">
                    ...
                    <tbody>
                        <?php foreach($listclients as $key) { ?>
                      <tr>
                        <td><?php echo $key['nom'] ?> </td>
                        <td><?php echo $key['prenom'] ?></td>
                        <td><?php echo $key['ddn'] ?></td>
                        <td><?php echo $key['tel'] ?></td>
                        <td><?php echo $key['adresse'] ?></td>
                        <td><?php echo $key['etat_civil'] ?></td>
                        <td> <a href="deleteclient.php?id=<?php echo $key['id'] ?>">Supprimer</a>
                        <a href="Editclient.php?id=<?php echo $key['id'] ?>">Modifier</a></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
