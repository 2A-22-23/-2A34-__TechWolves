	...
	<div class="col-md-7 col-md-pull-2 animate-box">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<p> id stock </p>
								<input id="id_stock" type="text" class="form-control" placeholder="id_stock"  name="id stock">
							</div>
						</div>
						<div class="col-md-6">
                        <div class="form-group">
							<p>--Choisir le type d'équipement --</p>
                            <select name="type" id="type" value="" class="btn btn-primary btn-modify">
								<option value="velo" name="type">Vélo</option>
								<option value="casque" name="type">Casque</option>
								<option value="sac" name="type">Sac</option>
							</select>
                        </div>
                    </div>
						<div class="col-md-12">
