...
<div class="fh5co-loader"></div>
					...
					<table>
						<tr>
							...
							<th><div class="col-md-12 col-offset-0 text-center">
							     	<div id="fh5co-logo"><a href="">E_veloc</a></div>
						        </div>
							</th>
						</tr>
					</table>
	...
	<div class="container-wrap">
        ...
        <h2>
            <a href="addstock.php">Ajouter un stock </a>
<hr>
			<a href="listequipement.php"> liste des equipements </a>
        </h2>
    </center>
        <div id="invoice">	
    <table border="1" align="center" width="70%">
        ...
        ?>
            <tr>
                <td><?= $client1['id_stock']; ?></td>
                <td><?= $client1['nb_velo']; ?></td>
                <td><?= $client1['nb_sac']; ?></td>
                <td><?= $client1['nb_casque']; ?></td>
                <td align="center">
                    <form method="POST" action="updatestock.php">
                        <input type="submit" name="update" value="Update">
                        <input type="hidden" value=<?PHP echo $client1['id_stock']; ?> name="id_stock">

                    </form>
                </td>
                <td>
                    <a href="deletestock.php?id=<?php echo $client1['id_stock']; ?>">Delete</a>
                </td>
            </tr>
        <?php
        }
